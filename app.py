...
scale_to_model = {
    "180p → 720p (1280x720) 4x": {
        "weights": "/content/drive/MyDrive/Image upcaler/UpscalingProject/Weights/best_srgan_generator2.pth",
        "lr_size": (320, 180),
        "scale": 4
    },
    "270p → 1080p (1920x1080) 4x": {
        "weights": "/content/drive/MyDrive/Image upcaler/UpscalingProject/Weights/best_srgan_generator.pth",
        "lr_size": (480, 270),
        "scale": 4
    },
    "720p → 1080p (1920x1080) 1.5x": {
        "weights": "/content/drive/MyDrive/Image upcaler/UpscalingProject/Weights/best_srgan_generator3.pth",
        "lr_size": (1280, 720),
        "scale": 1.5
    }
}
...
demo=gr.Interface(
      ...
      title="ScaleNet",
      description="Upload a low-resolution image and choose a target output resolution. This interface will auto-select the correct model (even if it was trained with an older architecture)."
  )
